function Card(props) {
  return (
    <div className="md:w-[600px] w-[300px] flex flex-col justify-between m-2 md:p-12 p-8 rounded-lg bg-orange-600 shadow cursor-pointer hover:shadowHover hover:transition-shadow">
