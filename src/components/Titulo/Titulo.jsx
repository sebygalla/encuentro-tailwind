    ...
    <section className="grid grid-cols-1 text-left container xl:ml-[70px] md:ml-6 font-['Poppins'] md:mt-[-100px] xl:mt-[150px] mx-auto z-20 absolute top-[30%] xl:top-[10%] md:top-[65%]">
      <div>
        <div className="flex flex-col">
          <span className="text-white p-2 md:text-lg text-sm mx-auto md:text-left md:ml-0">Iglesia Cristiana- Tristan Suarez</span>
          <h1 className="font-bold md:text-7xl md:ml-1  md:text-left text-center text-white text-3xl" >
            EL ENCUENTRO
          </h1>
        
          <p className="text-gray-300 md:text-base md:w-[600px] text-[10px] xl:text-lg text-center p-7 xl:w-[700px] md:-m-5  -mt-5 w-100 md:text-left font-light">
          ...
          <div className=" text-center md:ml-1.5 mt-0 md:text-left md:mt-8">
            <Boton>Ver más!</Boton>
          </div>
        </div>
      </div>
