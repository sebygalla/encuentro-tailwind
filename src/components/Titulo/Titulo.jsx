  ...
  return (
    <section className="w-full px-5 absolute xl:top-[70%] text-white left-[50%] transform -translate-x-1/2 -translate-y-1/2 md:top-[65%] top-[70%]">
      <div className="mx-auto max-w-4xl font-['Poppins'] md:gap-0 xl:gap-4 text-left">
        ...
        <h2 className="xl:text-xl text-lg font-bold uppercase text-blue-900">Iglesia Cristiana <span className="xl:text-4xl text-2xl">⛪</span></h2>
      
        <h1 className="text-[50px] -mt-3 font-semibold xl:text-[80px] md:text-[60px]">
          EL ENCUENTRO
        </h1>
        <p className=" -mt-2 font-light text-1xl md:text-xl xl:text-sm xl:tracking-[.9em]">
          Tristán Suárez
        </p>
