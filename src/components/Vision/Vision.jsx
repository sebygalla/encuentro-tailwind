  ...
  return (
    <>
      <div className="mb-10 grid  min-h-[100%] gap-10 p-8 text-justify md:grid-cols-2 md:p-10 xl:p-20">
        <p className="z-10 text-[16px] font-links font-medium text-white md:text-[18px] md:leading-6 animate-fade-right">
        ...
        <p className="z-10 text-[16px] font-links font-medium text-white md:text-[18px] md:leading-6 animate-fade-left">
