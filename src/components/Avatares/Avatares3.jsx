  ...
  return (
    <>
      <div className="flex items-center gap-4">
        <img
          src={props.imagenUno}
          className="z-[10] h-8 w-8 rounded-full object-cover md:ring-4 ring-white md:h-16 md:w-16 ring-2"
        />
        <img
          src={props.imagenDos}
        ...
        <img
          ...
          className="z-[2] -m-5 h-8 w-8 rounded-full object-cover md:ring-4 ring-white contrast-150 md:h-16 md:w-16 ring-2"
        />

        <img
          src={props.imagenOnce}
          className="z-[1] h-8 w-8 rounded-full object-cover md:ring-4 ring-white contrast-150 md:h-16 md:w-16 ring-2"
        />

        <img
          src={props.imagenDoce}
          className="z-[0] -m-5 h-8 w-8 rounded-full object-cover md:ring-4 ring-white contrast-150 md:h-16 md:w-16 ring-2"
        />
